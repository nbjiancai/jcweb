...
<script type="text/javascript">
    ...
    <div id="page-inner" class="container">
        ...
        <div >
            ...
            <a class="btn btn-success btn-xs" href="<?php echo U('/admin/diedit/addExperts');?>"><i class="glyphicon glyphicon-plus"></i>新增</a><p/>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one): $mod = ($i % 2 );++$i;?><tr>
                        <td ><img src="<?php echo ($one["thumb_path"]); ?>" onerror="this.src='/Public/static/images/default-timg.gif'" style="width: 90px;"></td>
                        <td ><?php echo ($one["name"]); ?></td>
                        <td>
                            <a class="btn btn-primary btn-xs" href="<?php echo U('/admin/diedit/expertPicture');?>?id=<?php echo ($one["id"]); ?>" ><i class="glyphicon glyphicon-picture"></i>插入/更换形象照</a>
                            <a class="btn btn-primary btn-xs" href="<?php echo U('/admin/diedit/addExperts');?>?id=<?php echo ($one["id"]); ?>" ><i class="glyphicon glyphicon-cog"></i>修改内容</a>
...
<script type="text/javascript">
    ...
    function doSpecial(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo U('/admin/diedit/doSpecial');?>",
            data:{"id":id},
            dataType:"json",
    ...
    function doneDel(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo U('/admin/diedit/doexpertDelete');?>",
            data:{"id":id},
            dataType:"json",
            success:function(ret){
                if(ret.msg=='succ'){
