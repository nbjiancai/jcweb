        ...
        <div id="TCrop">
            <form class="form-horizontal" id="myform" action="" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="face" id="attachment" style="width: 120px;height: 80px;" onclick="onFileUpload()"><img src="<?php echo ($stamp['offcial_seal']); ?>" onerror="this.src='/Public/static/images/default-timg.gif'" style="height: 100%;" /></div>
                        <input type="hidden" name="imgurl" value="<?php echo ($stamp['offcial_seal']); ?>" />
...
<script type="text/javascript">
    ...
    function onSave(){
        var options = {
            url: "<?php echo U('/admin/edit/saveyuangongImage');?>",
            dataType: 'json',
    ...
    function doneDel(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo U('/admin/edit/doyuangongDelete');?>",
            data:{"id":id},
            dataType:"json",
