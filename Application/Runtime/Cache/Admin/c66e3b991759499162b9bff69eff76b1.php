    ...
    <div id="page-inner" class="container">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <td><a class="btn btn-primary btn-xs" href="<?php echo U('/admin/edit/introduction');?>" ><i class="glyphicon glyphicon-cog"></i>修改</a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><a class="btn btn-primary btn-xs" href="/admin/edit/show.html?type=2" ><i class="glyphicon glyphicon-cog"></i>添加</a></td>
            </tr>
            </tbody>
        </table>
