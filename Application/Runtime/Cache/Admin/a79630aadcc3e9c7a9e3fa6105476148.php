                ...
                <div class="profile">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="form-group" style="text-align: center">
                            <a href="<?php echo U('/admin/diedit/yuangongPicture');?>?type=1" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i>编辑</a>
                        </div>
                    </div>
                <!-- End row -->
            </div>
...
<script type="text/javascript">
    ...
    function onSave(){
        var options = {
            url: "<?php echo U('/admin/diedit/saveRecruitmentInformation');?>",
            dataType: 'json',
