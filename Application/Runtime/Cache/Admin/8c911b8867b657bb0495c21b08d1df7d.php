...
<script type="text/javascript">
    ...
    <div id="page-inner" class="container">
        ...
        <p></p>
            ...
            <a href="<?php echo U('/admin/edit/addProduction');?>?de=<?php echo ($de); ?>" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus" ></i>新增</a>
            <p></p>
            <div>
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="<?php echo U('/admin/edit/informationPicture');?>?id=<?php echo ($one["id"]); ?>&type=P" ><i class="glyphicon glyphicon-picture"></i>插入/更换展示图片</a>
                                <a href="<?php echo U('/admin/edit/addProduction');?>?id=<?php echo ($one["id"]); ?>&de=<?php echo ($one["type"]); ?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i> 编辑</a>
...
<script type="text/javascript">
    ...
    function doneDel(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo U('/admin/edit/doProductionDelete');?>",
            data:{"id":id},
            dataType:"json",
