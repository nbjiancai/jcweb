...
<script type="text/javascript">
    ...
    <div id="page-inner" class="container">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active" id="de_A" name="de"><a href="/admin/edit/recruitment?de=A" >招贤纳士</a></li>
            <li role="presentation" id="de_B" name="de"><a href="/admin/edit/recruitment?de=B">团队建设</a></li>
        ...
        <p></p>
            ...
            <?php else: ?>
            <?php if($de == 'B'): ?><div class="row">
                <div class="profile">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <h3 style="text-align: center">团队建设</h3>
                        <hr />
                        <div class="item view view-tenth thumbnail ">
                            <img src="/Public/static/images/team/member1.jpg" alt="">
                        </div>
                        <p></p>
                        <div class="form-group" style="text-align: center">
                            <a href="<?php echo U('/admin/edit/yuangongPicture');?>?type=1" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i>编辑</a>
                        </div>
                    </div>
                <!-- End row -->
            </div>
...
<script type="text/javascript">
    ...
    function onSave(){
        var options = {
            url: "<?php echo U('/admin/edit/saveRecruitmentInformation');?>",
            dataType: 'json',
