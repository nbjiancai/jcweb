...
<div id="page-inner" class="container" >
    <div class="list-news col-md-12" style="text-align: center;">
        <ul class="nav nav-pills" style="display: inline-block;float: none;">
            <li role="presentation" class="active"><a name="information">动态资讯</a></li>
        </ul>
    </div>
<!--动态资讯的内容-->
    <div class="col-md-12">
        <div class="row">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-4" >
                <div class="thumbnail" style="min-height: 442px;" >
                    <a href="<?php echo U('/home/Information/informationDetail');?>?type=1&id=<?php echo ($vo['id']); ?>" >
                        <img src="<?php echo ($vo['information_images_path']); ?>" alt="..." class="img-responsive" onerror="this.src='/Public/static/images/1530789342_thumb.jpeg'">
                    </a>
                    <div class="caption info_detail">
                    <h3 style="height:26px;text-overflow:ellipsis; white-space:nowrap; overflow:hidden; "><?php echo ($vo["title"]); ?></h3>
                            <p><?php echo (date(Y年m月d日,strtotime($vo["save_time"]))); ?></p>
                        <p><?php $vo['content'] = strip_tags($vo['content']); echo ($vo["content"]); ?></p>
                    <p><a href="<?php echo U('/home/Information/informationDetail');?>?type=1&id=<?php echo ($vo['id']); ?>" >more></a></p>
                    </div>
                </div>
