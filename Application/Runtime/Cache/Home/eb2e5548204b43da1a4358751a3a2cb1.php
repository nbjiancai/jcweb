            ...
            <div class="row">
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-left">
                        <li>
                            <i class="glyphicon glyphicon-home"></i><a href="/home/index/inex">
                                主页
                            </a>
                        </li>
...
<div id="page-inner" class="container">
    <div class="container">
    <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay=".1s" align="center">
        <h3><?php echo ($rs["words1"]); ?></h3>
        <h3><?php echo ($rs["words2"]); ?></h3>
    </div>
    </div>
</div>
    <!-- map start-->
<div style="background-color:#f9f9f3 ">
    ...
    <div class="container">
        <!-- map end-->
        <h3 align="left"><?php echo ($rs["company_name"]); ?></h3>
        <h4 align="left"><i class="glyphicon glyphicon-phone-alt"></i>  联系电话:<?php echo ($rs["telephone"]); ?></h4>
        <h4 align="left"><i class="glyphicon glyphicon-comment"></i>  咨询邮箱：<?php echo ($rs["email"]); ?></h4>
        <h4 align="left"><i class="glyphicon glyphicon-map-marker"></i>  公司地址：<?php echo ($rs["address"]); ?></h4>
    </div>
