...
<div class="container" >
    <div class="titlename" >
        <h3 name="recruitment">招贤纳士</h3>
        <span class="line1"></span>
    </div>

    <div class="row">
        <div class=" col-sm-6 wow zoomIn"  style="text-align: center;padding: 50px 20px 30px; background-color: #f8f8f8;height: 500px;" data-wow-duration="1s" data-wow-delay=".3s">
            <img src="/Public/static/images/jiaru.png" style="width: 400px;height: 400px;">
        </div>
        <div class="col-sm-6 wow zoomIn" style="padding: 50px 20px 30px;background-color: #f8f8f8;height: 500px;" data-wow-duration="1s" data-wow-delay=".3s">
            <div class="col-md-1"></div>
            <div class="col-md-11" style="padding: 50px 0 ">
...
<?php if($bopic): ?><div class="container">
<div class="titlename" >
       <h3 name="yuangong">团队建设</h3>
    <span class="line1"></span>
</div>
</div>
<div class="container">
    <div class="row" >
            <?php if(is_array($bopic)): $i = 0; $__LIST__ = $bopic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xt): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-xs-3">
                    <center><img src="<?php echo ($xt["thumb_path"]); ?>" class="img-responsive img-rounded"  style="width:auto;max-height: 270px;"></center>
    ...
    <!--<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php if(is_array($bopic)): $i = 0; $__LIST__ = $bopic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xt): $mod = ($i % 2 );++$i;?><li data-target="#carousel-example-generic" data-slide-to="<?php echo ($i-1); ?>" class="<?php if($i == 1 ): ?>active<?php endif; ?>"></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ol>
        <div class="carousel-inner">
            <?php if(is_array($bopic)): $i = 0; $__LIST__ = $bopic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xt): $mod = ($i % 2 );++$i;?><div class='item <?php if($i == 1 ): ?>active<?php endif; ?>'>
                    <center><a href="/home/Information/pictureDetail"><img src="<?php echo ($xt["thumb_path"]); ?>" alt="" style="max-height: 540px;width: auto;"/></a></center>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
