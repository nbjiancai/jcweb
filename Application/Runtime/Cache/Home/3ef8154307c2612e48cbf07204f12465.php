...
<a name="">资料下载</a></br>
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo['save_path']); ?>" download="<?php echo ($vo['filename']); ?>"><?php echo ($vo["filename"]); ?></a></br><?php endforeach; endif; else: echo "" ;endif; ?>
<nav><?php echo ($pagination1); ?></nav>
<a name="standard">标准下载</a></br>
<?php if(is_array($standard)): $i = 0; $__LIST__ = $standard;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo['save_path']); ?>" download="<?php echo ($vo['filename']); ?>"><?php echo ($vo["filename"]); ?></a></br><?php endforeach; endif; else: echo "" ;endif; ?>
