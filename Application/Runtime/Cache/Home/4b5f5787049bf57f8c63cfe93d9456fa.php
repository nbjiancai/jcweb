        ...
        <div class="row">
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-left">
                    ...
                    <li>
                        <?php if($type == A): ?><a href="/home/Information/production">
                                高性能外延材料与器件
                            </a>
                            <?php else: ?>
                            <a href="/home/Information/production#waiyan">
                                专用设备服务
                            </a><?php endif; ?>
...
<div class="container" style="width:1200px;padding-right: 160px;padding-left: 160px;">
    <div class="row" >
...
<script type="text/javascript">
    ...
    $(function(){
        $("pf-detail").find("img").each(function(){
            var w = $(this).width(),
                h = $(this).height();
            if(w >= 880 || w == 0){
                $(this).css({
