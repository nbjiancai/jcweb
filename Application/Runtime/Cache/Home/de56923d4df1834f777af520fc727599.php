...
<div class="container-two" id="container-content" style="position: relative" }>
    <div class="col-xs-2 col-md-2 left-menu">
        <ul>
            <li><a href="/Home/Information/basic">质检流程</a></li>
            <li><a href="/Home/Information/structure">质检范围</a></li>
...
<?php if(is_array($scope)): $i = 0; $__LIST__ = $scope;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('/home/Information/scopeDetail');?>?id=<?php echo ($vo['id']); ?>"><?php echo ($vo["title"]); ?></a></br><?php endforeach; endif; else: echo "" ;endif; ?>
